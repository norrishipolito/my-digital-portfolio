        ...
        >
            <Box width={{ base: 'full', sm: 'lg', lg: 'xl' }} mx={'auto'}>
                ...
                <chakra.h1 py={5} fontSize={48} fontWeight={'bold'}>
                    Lexmark, Where I was Able to Improve
                </chakra.h1>
                <chakra.h2
                    margin={'auto'}
                    width={'70%'}
                ...
                >
                    Aside from my own comments, suggestions and recommendations regarding
                    Lexmark, my
                    ...
                    <chakra.strong color={useColorModeValue('gray.100', 'gray.50')}>
                        {' '}
                        feedbacks, assesment and evaluation
                    </chakra.strong>{' '}
                    of how I did during my internship
                </chakra.h2>
            </Box>
            <SimpleGrid
                columns={{ base: 1, xl: 2 }}
