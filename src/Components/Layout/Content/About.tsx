                    ...
                    <VStack spacing={{ base: 4, md: 8, lg: 20 }}>
                        ...
                        <Stack
                            ...
                            <Stack
                                ...
                                <Link href="https://mail.google.com/mail/u/0/#inbox?compose=GTvVlcRwPxTzmzcTtwFKnngvhtdDLkgJQcFfQFxncQlmbPFJvrkSGMHjmSzlZdWRbhRDStqkjTWQh" target={'_blank'}>
                                    <IconButton
                                        aria-label="Gmail"
                                        variant="ghost"
                                        size="lg"
                                ...
                                <Link href="https://github.com/norrisasd" target={'_blank'}>
                                    <IconButton
                                        aria-label="github"
                                        variant="ghost"
                                        size="lg"
                                ...
                                <Link href="https://twitter.com/Norrizasd" target={'_blank'}>
                                    <IconButton
                                        aria-label="twitter"
                                        variant="ghost"
                                        size="lg"
                                ...
                                <Link href="https://www.linkedin.com/in/norris-hipolito-jr-a67574209/" target={'_blank'}>
                                    <IconButton
                                        aria-label="linkedin"
                                        variant="ghost"
                                        size="lg"
                            ...
                            <Box
                                bg={useColorModeValue('#1a374d', 'gray.700')}
                                width={'4xl'}
                                borderRadius="lg"
                                p={8}
